...
void InputController::InitKeymapping() {
	...
	keyMapping[GLFW_KEY_W] = CreateKeyAction(PLAYER, FORWARD, NONE, PLAYER_MOVE_FORWARD, PLAYER_MOVE_STOP, SYSTEM_NONE);
	keyMapping[GLFW_KEY_S] = CreateKeyAction(PLAYER, BACK, NONE, PLAYER_MOVE_BACK, PLAYER_MOVE_STOP, SYSTEM_NONE);
	keyMapping[GLFW_KEY_D] = CreateKeyAction(PLAYER, RIGHT, NONE, PLAYER_MOVE_RIGHT, PLAYER_MOVE_STOP, SYSTEM_NONE);
	keyMapping[GLFW_KEY_A] = CreateKeyAction(PLAYER, LEFT, NONE, PLAYER_MOVE_LEFT, PLAYER_MOVE_STOP, SYSTEM_NONE);
	keyMapping[GLFW_KEY_SPACE] = CreateKeyAction(PLAYER, UP, NONE, PLAYER_MOVE_UP, PLAYER_MOVE_STOP, SYSTEM_NONE);
	keyMapping[GLFW_KEY_C] = CreateKeyAction(PLAYER, DOWN, NONE, PLAYER_MOVE_DOWN, PLAYER_MOVE_STOP, SYSTEM_NONE);
